...
export class ExistSubMachine extends SubStateMachine {
  ...
  constructor(public fms: StateMachine) {
    ...
    this.stateMachines.set(PARAMS_NAME_DIRECTIO_ENUM.RIGHT, new State(fms, `${PATH}/left`, AnimationClip.WrapMode.Loop));
    this.stateMachines.set(PARAMS_NAME_DIRECTIO_ENUM.BOTTOM, new State(fms, `${PATH}/top`, AnimationClip.WrapMode.Loop));
