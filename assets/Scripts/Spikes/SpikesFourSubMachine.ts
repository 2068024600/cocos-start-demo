...
const PATH = "texture/spikes/spikesfour"

export class SpikesFourSubMachine extends SubStateMachine {
  ...
  constructor(public fms: StateMachine) {
    ...
    this.stateMachines.set(PARAMS_SPIKES_NUMBER_ENUM.FOUR, new State(fms, `${PATH}/four`));
    this.stateMachines.set(PARAMS_SPIKES_NUMBER_ENUM.FIVE, new State(fms, `${PATH}/five`));
  }
