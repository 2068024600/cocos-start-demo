import { PARAMS_NAME_DIRECTION_ENUM, ENTITY_STATE_ENUM, ENTITY_TYPE_ENUM, TILE_TYPE_ENUM, SPIKES_TYPE_ENUM } from '../Enums';
...
const player: IEntity = {
  x: 0,
  y: -8,
  direction: PARAMS_NAME_DIRECTION_ENUM.RIGHT,
